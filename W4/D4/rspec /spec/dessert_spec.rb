...
describe Dessert do
  ...
  describe "#add_ingredient" do
    it "adds an ingredient to the ingredients array" do 
      cake.add_ingredient("fruits")
      expect(cake.ingredients).to include("fruits")
    end 
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do 
      ingredients = ["apple", "vanilla", "frosting", "pork chop"]
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do 
      allow(chef).to receive(:titleize).and_return("Jacky")
      expect(cake.serve).to eq("Jacky has made 10 cakes!")
    end 
  end
